...
class VSIFile:
    ...
    def __init__(self, vsi_file: str, skip_dict: dict,
        ...
        :param skip_dict: Dictionary that indexes of the slides to skip, if they're empty, and progress tracking
        :param roi_size: Size of the roi to extract from the slide, (height, weidth)
        ...
        if self.skip_dict:
            self.skip = set(self.skip_dict['skip'])
            self.idx = self.skip_dict['idx']
